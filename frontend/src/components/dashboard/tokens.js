...
export const PRIMARY_CTA =
  'bg-turf-btn hover:bg-turf-btn-dark text-white focus-visible:ring-2 focus-visible:ring-turf focus-visible:ring-offset-2';
...
export const ON_DARK_CTA =
  'bg-turf-btn hover:bg-turf-btn-dark text-white focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent';
