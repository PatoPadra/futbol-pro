...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // rounded-2xl unconditionally (not just sm:) — the old sm:rounded-lg
        // left every dialog with square corners below the sm breakpoint,
        // i.e. on the mobile viewports this app is designed for first.
